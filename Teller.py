                    ...
                    if(len(password_entry_box.get()) == 4):
                        if not (int(amount_entry_box.get()) <= 100):
                            try:
                                ...
                                messagebox.showinfo("SRM AP ATM Machine", " New Customer Added Successfully. "
                                ...
                                messagebox.showerror("SRM AP ATM Machine", " Try Again Later")
                        else:
                            messagebox.showerror("SRM AP ATM Machine", " Initial Amount Must Be Bigger Than $100")
                    else:
                        messagebox.showerror("SRM AP ATM Machine", " The Password Should Be 4 Character")
                else:
                    messagebox.showerror("SRM AP ATM Machine", " No information can be left blank.")
            else:
                messagebox.showerror("SRM AP ATM Machine", " Fill in all the information.")
